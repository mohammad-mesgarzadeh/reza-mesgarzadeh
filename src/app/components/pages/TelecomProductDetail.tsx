...
function ImageZoom({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "relative h-[300px] sm:h-[400px] lg:h-[500px] rounded-xl overflow-hidden bg-secondary group cursor-pointer",
    ...
    >
      <img
        ...
        draggable={false}
        className={cn(
          "w-full h-full object-cover transition-transform duration-200 ease-out select-none",
